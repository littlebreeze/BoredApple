...
public class GameRoomService {
    ...
    public List<GameRoomRes> getRooms(int pageNum) {
        Pageable pageable = PageRequest.of(pageNum, 2, Sort.by("id").ascending());
...
//                    .roomCreatorId()
    ...
    public void createRoom(GameRoomReq gameRoomReq) {
        GameRoom gameRoom = GameRoom.builder()
                .id(gameRoomReq.getId())//id 가장 작은 값으로 배정 로직 만들기
