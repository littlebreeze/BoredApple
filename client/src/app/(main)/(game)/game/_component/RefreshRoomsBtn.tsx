export default function RefreshRoomsBtn() {
  return (
    <>
      <div className='bg-white/80 rounded-md cursor-pointer w-full h-11 flex justify-center items-center border-2 gap-1 border-white hover:border-ourGreen duration-100'>
