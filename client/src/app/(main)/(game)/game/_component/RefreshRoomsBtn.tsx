export default function RefreshRoomsBtn() {
  return (
    <>
      <div className='bg-white/80 rounded-md cursor-pointer w-full h-11 flex justify-between items-center px-6 border-2 border-white hover:border-ourGreen  duration-100'>
